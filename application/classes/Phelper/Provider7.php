...
class Phelper_Provider7 extends Phelper_Provider{
    private $models;
    private $articles;
    public function __construct(){
        $bench = Profiler::start('providers','7');
        $this->provider_id = 7;
        $this->provider_name = 'provider_'.$this->provider_id.'_'.date('d_m_y').'.csv';
        $this->provider_url = 'http://www.eroteam.biz/items_export.html?descr=1';
        $this->use_cookie = true;
        $this->provider_cookie = 'PHPSESSID=dd38bbd3e02417f1d9160f1d200c5390; lt-vc=1; lt-on-site-time=1438869624; auth=1015%2Cfde1531708689a908b83f79d29052525; _ym_visorc_21324613=w; lt-ejbr=63011096; lt-tl=ejbr';
